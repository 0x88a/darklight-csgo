...
void CAutoWall::ScaleDamage(int iHitGroup, CBaseEntity* pEntity, float flWeaponArmorRatio, float& flDamage)
{
	...
	static CConVar* mp_damage_scale_ct_head = I::ConVar->FindVar(_("mp_damage_scale_ct_head"));
	static CConVar* mp_damage_scale_t_head = I::ConVar->FindVar(_("mp_damage_scale_t_head"));

	static CConVar* mp_damage_scale_ct_body = I::ConVar->FindVar(_("mp_damage_scale_ct_body"));
	static CConVar* mp_damage_scale_t_body = I::ConVar->FindVar(_("mp_damage_scale_t_body"));
